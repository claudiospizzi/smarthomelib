 ...
 */
export function useValueOrDefault<T>(reference: string, value: T | undefined, defaultValue: T): T {
  if (value !== undefined) {
 ...
 */
export function useValueOrThrow<T>(reference: string, value: T | undefined): T {
  if (value === undefined) {
